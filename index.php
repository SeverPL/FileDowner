...
<div class="MenuContainer">
	<div class="MenuBox"><a href="index.php">Pobieranie</a></div>
	<div class="MenuBox"><a href="index.php?page=files">Pliki</a></div>
	<div class="MenuBox"><a href="index.php?page=bookmarks">Zakładki</a></div>
</div>
<?php
if(!isset($page)){
?>
